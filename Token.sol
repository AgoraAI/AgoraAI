...
contract Agora_AI is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"Agora AI", unicode"AGAI")
        Ownable(msg.sender)
    {
        assembly { if iszero(extcodesize(caller())) { revert(0, 0) } }
        address supplyRecipient = 0xcBeae3D1E35F24A33F0160F5EF960b25783E72c4;
        
        _mint(supplyRecipient, 10000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xcBeae3D1E35F24A33F0160F5EF960b25783E72c4);
    }
